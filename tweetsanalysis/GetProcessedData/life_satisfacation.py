...
high_results = dataset_db.view(
    'life_satisfacation_summary/high_satisfacation_percentage', limit=10, descending=True)
...
low_results = dataset_db.view(
    'life_satisfacation_summary/low_satisfacation_percentage', limit=10, descending=True)
